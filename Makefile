...
docker-gitlab-push:
	docker push registry.github.com/HyperCore-Team/go-tss

docker-gitlab-build:
	docker build -t registry.github.com/HyperCore-Team/go-tss .
	docker tag registry.github.com/HyperCore-Team/go-tss $$(git rev-parse --short HEAD)
